...
static const u32 sWeatherFlagsInfo[][3] =
{
    ...
    [ENUM_WEATHER_LIGHTNING_STORM] = {B_WEATHER_LIGHTNING_STORM, B_WEATHER_LIGHTNING_STORM, HOLD_EFFECT_NONE},
    [ENUM_WEATHER_EARTHQUAKE] = {B_WEATHER_EARTHQUAKE, B_WEATHER_EARTHQUAKE, HOLD_EFFECT_NONE},
    [ENUM_WEATHER_ETHER] = {B_WEATHER_ETHER, B_WEATHER_ETHER, HOLD_EFFECT_NONE},
    [ENUM_WEATHER_POLLEN] = {B_WEATHER_POLLEN, B_WEATHER_POLLEN, HOLD_EFFECT_NONE},
    [ENUM_WEATHER_TORNADO] = {B_WEATHER_TORNADO, B_WEATHER_TORNADO, HOLD_EFFECT_NONE},
    [ENUM_WEATHER_REGULAR_DAY] = {B_WEATHER_REGULAR_DAY, B_WEATHER_REGULAR_DAY, HOLD_EFFECT_NONE},
    [ENUM_WEATHER_HUMID] = {B_WEATHER_HUMID, B_WEATHER_HUMID, HOLD_EFFECT_NONE},
    [ENUM_WEATHER_ECLIPSE] = {B_WEATHER_ECLIPSE, B_WEATHER_ECLIPSE, HOLD_EFFECT_NONE},
    [ENUM_WEATHER_ACID_RAIN] = {B_WEATHER_ACID_RAIN, B_WEATHER_ACID_RAIN, HOLD_EFFECT_NONE},
    [ENUM_WEATHER_RAINBOW] = {B_WEATHER_RAINBOW, B_WEATHER_RAINBOW, HOLD_EFFECT_NONE},
    [ENUM_WEATHER_SOLAR_FLARE] = {B_WEATHER_SOLAR_FLARE, B_WEATHER_SOLAR_FLARE, HOLD_EFFECT_NONE},
};
