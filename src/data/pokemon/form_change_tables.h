...
static const struct FormChange sCastformFormChangeTable[] = {
    ...
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM_ACID, B_WEATHER_ACID_RAIN, ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM_EARTHQUAKE, B_WEATHER_EARTHQUAKE, ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM_ECLIPSE, B_WEATHER_ECLIPSE, ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM_ETHER, B_WEATHER_ETHER, ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM_FOG, B_WEATHER_FOG, ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM_HUMID, B_WEATHER_HUMID, ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM_LIGHTNING, B_WEATHER_LIGHTNING_STORM, ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM_POLLEN, B_WEATHER_POLLEN, ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM_RAINBOW, B_WEATHER_RAINBOW, ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM_SANDSTORM, B_WEATHER_SANDSTORM, ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM_SOLARFLARE, B_WEATHER_SOLAR_FLARE, ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM_TORNADO, B_WEATHER_TORNADO, ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM_NORMAL, B_WEATHER_REGULAR_DAY, ABILITY_FORECAST},
    ...
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM_ACID, B_WEATHER_ACID_RAIN},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM_EARTHQUAKE, B_WEATHER_EARTHQUAKET},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM_ECLIPSE, B_WEATHER_ECLIPSE},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM_ETHER, B_WEATHER_ETHER},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM_FOG, B_WEATHER_FOG},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM_HUMID, B_WEATHER_HUMID},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM_LIGHTNING, B_WEATHER_LIGHTNING_STORM},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM_POLLEN, B_WEATHER_POLLEN},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM_RAINBOW, B_WEATHER_RAINBOW},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM_SANDSTORM, B_WEATHER_SANDSTORM},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM_SOLARFLARE, B_WEATHER_SOLAR_FLARE},
#endif
