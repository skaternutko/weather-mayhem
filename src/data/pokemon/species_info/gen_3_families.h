...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_LOTAD] =
    {
        ...
        .abilities = { ABILITY_OWN_TEMPO, ABILITY_NONE, ABILITY_OWN_TEMPO },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Lotad"),
        .cryId = CRY_LOTAD,
    ...
    [SPECIES_SEEDOT] =
    {
        ...
        .abilities = { ABILITY_EARLY_BIRD, ABILITY_NONE, ABILITY_PICKPOCKET },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_SHIFTRY] =
    {
        ...
        .abilities = { ABILITY_WIND_RIDER, ABILITY_EARLY_BIRD, ABILITY_PICKPOCKET },
    #else
        .abilities = { ABILITY_WIND_RIDER, ABILITY_EARLY_BIRD, ABILITY_PICKPOCKET },
    #endif
        .bodyColor = BODY_COLOR_BROWN,
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_SURSKIT] =
    {
        ...
        .abilities = { ABILITY_WATER_VEIL, ABILITY_NONE, ABILITY_WATER_VEIL },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_GOREBYSS] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1),
        .abilities = { ABILITY_WATER_VEIL, ABILITY_NONE, ABILITY_HYDRATION },
        .bodyColor = BODY_COLOR_PINK,
